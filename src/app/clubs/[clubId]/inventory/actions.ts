...
async function assertSessionUserCanAccessClub(
  clubId: string,
...
async function resolveEffectiveEmployeeWarehouseIds(
  client: any,
  clubId: string,
...
function normalizeShiftZoneKey(
  raw: any,
...
async function getInventoryAccessScope(
  client: any,
  clubId: string,
  userId: string,
...
async function assertUserCanUseWarehouses(
  client: any,
  clubId: string,
  userId: string,
...
async function getShiftAccountabilityWarehousesInternal(
  client: any,
  clubId: string,
  userId: string,
) {
...
async function getShiftForZoneAccountability(
  client: any,
  clubId: string,
  shiftId: string,
  sessionUserId: string,
...
async function getShiftZoneDiscrepancyReportInternal(
  client: any,
  clubId: string,
  shiftId: string,
  sessionUserId: string,
...
async function assertWarehouseBelongsToClub(
...
async function assertProductBelongsToClub(
  db: { query: (sql: string, params?: any[]) => Promise<any> },
  clubId: string,
  productId: number,
) {
...
async function assertProductsBelongToClub(
  db: { query: (sql: string, params?: any[]) => Promise<any> },
  clubId: string,
  productIds: number[],
) {
...
async function getLockedWarehouseStock(
  client: any,
  warehouseId: number,
  productId: number,
) {
...
function calculateSuggestedProcurementQuantity(
  product: {
...
function getProcurementPriority(
  abcCategory: string,
...
function getProcurementCandidate(
  product: {
    current_stock: number | string | null;
    sales_velocity: number | string | null;
    min_stock_level?: number | string | null;
...
async function getClubInventorySettingsInternal(
  client: any,
  clubId: string,
