...
import SimplifiedFinance from "./_components/SimplifiedFinance"

export default function FinancePage() {
    const params = useParams()
    const clubId = params?.clubId as string

    const [activeTab, setActiveTab] = useState('simplified-finance')
        ...
        <PageShell maxWidth="5xl">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                <TabsList className="w-full md:w-auto bg-slate-100/50 border border-slate-200 p-1.5 rounded-2xl mb-8 shadow-sm flex overflow-x-auto">
                    <TabsTrigger value="simplified-finance" className="rounded-xl px-6 py-2.5 font-medium text-slate-500 data-[state=active]:bg-white data-[state=active]:text-slate-900 data-[state=active]:shadow-sm transition-all">Финансы 2.0</TabsTrigger>
                ...
                <TabsContent value="simplified-finance" className="focus-visible:outline-none">
                    <SimplifiedFinance />
                </TabsContent>
            </Tabs>
