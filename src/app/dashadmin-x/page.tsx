...
import { Building2, Users, CreditCard, TrendingUp, ArrowRight, Loader2 } from "lucide-react"
                                    ...
                                    <div>
                                        ...
                                        <p className="text-3xl font-bold tracking-tight text-slate-900">
                                            {isLoading ? (
                                                ...
                                                new Intl.NumberFormat('ru-RU').format(Number(stat.value))
                                            )}
                                        </p>
                                    </div>
                                </Card>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">Добавить, редактировать, удалить</p>
                            </div>
                        </Link>
                        <Link
                            href="/dashadmin-x/clubs"
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">Просмотр и настройка клубов</p>
                            </div>
                        </Link>
                        <Link
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            <div className={cn(
                                                ...
                                                activity.type === "subscription_change" && "bg-amber-100"
                                            )}>
                                                {activity.type === "new_user" && <Users className="h-4 w-4 text-blue-600" />}
                                                {activity.type === "new_club" && <Building2 className="h-4 w-4 text-emerald-600" />}
                                                {activity.type === "subscription_change" && <CreditCard className="h-4 w-4 text-amber-600" />}
                                            </div>
