...
export const EQUIPMENT_ICON_OPTIONS = [
  ...
  { value: "circuit-board", label: "Платы/GPU" },
  { value: "memory-stick", label: "Память" },
  { value: "zap", label: "Блок питания" },
  { value: "hard-drive", label: "Диск" },
  { value: "fan", label: "Вентилятор" },
];
export function resolveEquipmentIconKey(
  type?: string | null,
