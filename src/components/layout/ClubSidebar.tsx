...
export function ClubSidebar({ clubId }: ClubSidebarProps) {
    ...
    const settingsLinks = [
        ...
        { href: `/clubs/${clubId}/settings/finance`, label: 'Финансы', icon: <DollarSign className="h-4 w-4" /> },
        ...
        { href: `/clubs/${clubId}/settings/equipment`, label: 'Оборудование (KPI)', icon: <Wrench className="h-4 w-4" /> },
    ]

    return (
        <aside className="w-64 border-r border-border bg-card flex-col flex">
