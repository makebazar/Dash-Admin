...
ALTER TABLE shifts ADD COLUMN IF NOT EXISTS report_data JSONB DEFAULT '{}'::jsonb;
ALTER TABLE shifts ADD COLUMN IF NOT EXISTS template_id INTEGER REFERENCES club_report_templates(id);
